...
const SendFile_MDRRMO = () => {
  ...
  const [selectedOfficeCategory, setSelectedOfficeCategory] = useState('MDDRMO/MEO/MPDO/MSWDO');
  const [selectedOffice, setSelectedOffice] = useState('MDDRMO/MEO/MPDO/MSWDO');
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      if (!isInitialized) {
        ...
        document.getElementById('file-upload-mdrrmo').click();
      }
    }, 100);
  ...
  const extractEmployeeData = (worksheet) => {
    ...
    const employeeRows = [
      ...
      // MEO Section - Rows 21-25 (Note: Row 21 is JOVENTINO O. PACA, JR.)
  ...
  const handleSendFile = async () => {
    ...
    try {
      ...
      // In the handleSendFile function of SendFile_MDRRMO.jsx, update the fileData object:
...
const fileData = {
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              <input
                ...
                placeholder="Enter filename (e.g., payroll_mddrmo_jan2024)"
                autoFocus
              />
            ...
            <div className="mt-4 p-4 bg-blue-50 rounded-xl border border-blue-200">
              ...
              <ul className="text-sm text-blue-700 space-y-1">
                <li>• Use descriptive names like "payroll_mddrmo_january_2024"</li>
  ...
  if (hasError) {
    return (
      <div className=" bg-red-50 flex items-center justify-center p-6">
  ...
  return (
    <div className="bg-green-100 p-6 min-h-screen">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-800">MDDRMO/MEO/MPDO/MSWDO - Payroll Processing</h1>
          <p className="text-gray-600 mt-2">Upload payroll Excel file and update employee data (PAYROLL1.xlsx format)</p>
        </div>
        <div className="flex items-center gap-4">
          ...
          <input 
            id="file-upload-mdrrmo" 
            name="file-upload-mdrrmo" 
            type="file" 
            accept=".xlsx,.xls"
        ...
        {excelData && Object.keys(employeeData).length > 0 && (
          <div className="bg-white rounded-xl shadow-2xl p-8">
            ...
            <div className="flex justify-between items-center mb-8 pb-6 border-b border-gray-300">
              <div>
                <h2 className="text-3xl font-bold text-gray-800">PAYROLL1.xlsx Data Table</h2>
            ...
            {/* Main Table - Based on PAYROLL1.xlsx column structure */}
                  ...
                  {Object.keys(employeeData).map((employeeName) => {
                    ...
                    return (
                      <tr key={employeeName} className={rowClass}>
                        ...
                        {/* Paid in Cash - Column W (Note: No Column V in PAYROLL1.xlsx, skips to W) */}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 text-blue-800">
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2 text-lg">
                    ...
                    <li><strong>PAYROLL1.xlsx format:</strong> Uses columns G through W</li>
                  </ul>
                </div>
              </div>
            </div>
...
export default SendFile_MDRRMO;