      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full p-6">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-bold text-gray-800">Loading Excel Data (MDRRMO Format)...</h2>
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-[95vw] w-full max-h-[90vh] overflow-hidden">
        ...
        <div className="bg-blue-600 text-white px-6 py-4 flex justify-between items-center">
          <div>
            <h2 className="text-xl font-semibold">MDRRMO/MEO/MPDO/MSWDO - {file.fileName}</h2>
        ...
        {/* Main Table - MDRRMO Format */}
        <div className="overflow-auto max-h-[calc(90vh-8rem)] p-4">
          <div className="min-w-max">
            <table className="min-w-full border-collapse text-sm">
              <thead className="bg-gray-200">
                <tr>
                  <th className="border border-gray-400 px-2 py-2 font-bold text-gray-900 text-center" rowSpan="2" style={{ minWidth: '60px' }}>SENIOR</th>
                  <th className="border border-gray-400 px-2 py-2 font-bold text-gray-900 text-center" rowSpan="2" style={{ minWidth: '60px' }}>NO.</th>
                  <th className="border border-gray-400 px-2 py-2 font-bold text-gray-900" rowSpan="2" style={{ minWidth: '180px' }}>NAME</th>
                  <th className="border border-gray-400 px-2 py-2 font-bold text-gray-900" rowSpan="2" style={{ minWidth: '150px' }}>DESIGNATION</th>
                  <th className="border border-gray-400 px-2 py-2 font-bold text-gray-900 text-center" colSpan="2" style={{ minWidth: '200px' }}>PERIOD OF SERVICE</th>
                  <th className="border border-gray-400 px-2 py-2 font-bold text-gray-900 text-center" rowSpan="2" style={{ minWidth: '100px' }}>MONTHLY RATE</th>
                  <th className="border border-gray-400 px-2 py-2 font-bold text-gray-900 text-center" rowSpan="2" style={{ minWidth: '100px' }}>AMOUNT ACCRUED</th>
                  <th className="border border-gray-400 px-2 py-2 font-bold text-gray-900 text-center" colSpan="2" style={{ minWidth: '160px' }}>GSIS LOANS</th>
                  <th className="border border-gray-400 px-2 py-2 font-bold text-gray-900 text-center" colSpan="2" style={{ minWidth: '160px' }}>PHILHEALTH</th>
                  <th className="border border-gray-400 px-2 py-2 font-bold text-gray-900 text-center" colSpan="2" style={{ minWidth: '160px' }}>GSIS PREMIUMS</th>
                  <th className="border border-gray-400 px-2 py-2 font-bold text-gray-900 text-center" colSpan="2" style={{ minWidth: '160px' }}>PAG-IBIG</th>
                  <th className="border border-gray-400 px-2 py-2 font-bold text-gray-900 text-center" colSpan="5" style={{ minWidth: '400px' }}>OTHER DEDUCTIONS</th>
                  <th className="border border-gray-400 px-2 py-2 font-bold text-gray-900 text-center" rowSpan="2" style={{ minWidth: '100px' }}>PAID IN CASH</th>
                </tr>
                <tr>
                  ...
                  <th className="border border-gray-400 px-2 py-2 font-bold text-gray-900 text-center" style={{ minWidth: '80px' }}>EDUC LOAN</th>
                  <th className="border border-gray-400 px-2 py-2 font-bold text-gray-900 text-center" style={{ minWidth: '80px' }}>MPL LOAN</th>
                  <th className="border border-gray-400 px-2 py-2 font-bold text-gray-900 text-center" style={{ minWidth: '80px' }}>PERSONAL</th>
                  <th className="border border-gray-400 px-2 py-2 font-bold text-gray-900 text-center" style={{ minWidth: '80px' }}>GOVERNMENT</th>
                  <th className="border border-gray-400 px-2 py-2 font-bold text-gray-900 text-center" style={{ minWidth: '80px' }}>PERSONAL</th>
                  <th className="border border-gray-400 px-2 py-2 font-bold text-gray-900 text-center" style={{ minWidth: '80px' }}>GOVERNMENT</th>
                  <th className="border border-gray-400 px-2 py-2 font-bold text-gray-900 text-center" style={{ minWidth: '80px' }}>PERSONAL</th>
                  <th className="border border-gray-400 px-2 py-2 font-bold text-gray-900 text-center" style={{ minWidth: '80px' }}>GOVERNMENT</th>
        ...
        <div className="border-t border-gray-300 px-6 py-4 bg-gray-50">
          <h3 className="font-bold text-gray-800 mb-2">💡 Instructions (MDRRMO/MEO/MPDO/MSWDO Format):</h3>
          <div className="text-sm text-gray-600 grid grid-cols-2 gap-4">
            ...
            <div>
              <ul className="list-disc list-inside space-y-1">
                ...
                <li><strong>Office:</strong> MDRRMO/MEO/MPDO/MSWDO</li>
              </ul>
            </div>
          </div>
          {!editingEnabled && (
