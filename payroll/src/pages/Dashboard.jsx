...
const Dashboard = () => {
  ...
  // Palihog sa Dashboard.jsx, ilisi ang handleReceiveFile function:
const handleReceiveFile = () => {
  console.log('Receive File clicked');
  navigate('/file'); // IMPORTANTE: i-change gikan sa '/receive-file' padung sa '/file-received'
};
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-medium">Send File</h3>
                    <p className="text-blue-600 mt-2">Securely transfer files</p>
                  </div>
                </div>
              </button>
              ...
              >
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-green-600 mt-2">Get files sent to you safely</p>
                  </div>
                </div>
              </button>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <button 
              ...
              className="bg-purple-50 hover:bg-purple-100 text-purple-800 rounded-lg p-6 w-full transition duration-200 ease-in-out border border-purple-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50 text-left"
            >
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-medium">Print File</h3>
                  <p className="text-purple-600 mt-2">Print documents directly from your dashboard</p>
                </div>
              </div>
            </button>
          </div>
