...
const SendFile_MAYOR = () => {
  ...
  const [selectedOfficeCategory, setSelectedOfficeCategory] = useState('MAYOR/ACCT/MBO/MASSO');
  const [selectedOffice, setSelectedOffice] = useState('MAYOR/ACCT/MBO/MASSO');
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      if (!isInitialized) {
        ...
        document.getElementById('file-upload-rhu-1').click();
      }
    }, 100);
  ...
  // In the handleSendFile function of SendFile_MAYOR.jsx:
...
const handleSendFile = async () => {
  ...
  if (!selectedOfficeCategory) {
    alert('Office information is missing. Please refresh and try again.');
    return;
  }
  ...
  try {
    ...
    const fileData = {
      ...
      officeDisplay: selectedOfficeCategory, // Add display field
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              <input
                ...
                placeholder="Enter filename (e.g., payroll_mayor_jan2024)"
                autoFocus
              />
            ...
            <div className="mt-4 p-4 bg-blue-50 rounded-xl border border-blue-200">
              ...
              <ul className="text-sm text-blue-700 space-y-1">
                <li>• Use descriptive names like "payroll_mayor_january_2024"</li>
  ...
  return (
    <div className="bg-green-100 p-6 min-h-screen">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-800">MAYOR/ACCT/MBO/MASSO - Payroll Processing</h1>
          <p className="text-gray-600 mt-2">Upload payroll Excel file and update employee data (PAYROLL4.xlsx format)</p>
        </div>
        <div className="flex items-center gap-4">
          ...
          <input 
            id="file-upload-rhu-1" 
            name="file-upload-rhu-1" 
            type="file" 
            accept=".xlsx,.xls"
        ...
        {excelData && Object.keys(employeeData).length > 0 && (
          <div className="bg-white rounded-xl shadow-2xl p-8">
            ...
            <div className="flex justify-between items-center mb-8 pb-6 border-b border-gray-300">
              <div>
                <h2 className="text-3xl font-bold text-gray-800">PAYROLL4.xlsx Data Table</h2>
            ...
            {/* Main Table - Based on PAYROLL4.xlsx column structure */}
                  ...
                  {Object.keys(employeeData).map((employeeName) => {
                    ...
                    return (
                      <tr key={employeeName} className={rowClass}>
                        ...
                        {/* Paid in Cash - Column W (Note: No Column V in PAYROLL4.xlsx, skips to W) */}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 text-blue-800">
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2 text-lg">
                    ...
                    <li><strong>PAYROLL4.xlsx format:</strong> Uses columns G through W</li>
                  </ul>
                </div>
              </div>
            </div>
